...
export default function PurchaseOrderListTable() {
  ...
  return (
    <div className="xl:space-y-12 md:space-y-8 space-y-6">
      <div style={{background: "linear-gradient(104deg, #2E1345 16.28%, #0A2943 100%)", boxShadow: "0px 11px 11px 0px rgba(87, 173, 208, 0.11) inset"}} className="p-4 border border-white/30 rounded-lg">
        <h5 className="text-center xl:text-2xl md:text-xl text-lg">Purchase People List</h5>
      </div>
