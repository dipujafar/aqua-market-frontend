  ...
  return (
    <div>
      ...
      {feedbacksData?.slice(0, showReview).map((feedback) => (
        <div key={feedback?._id} className="flex md:mt-8 mt-6 gap-x-2">
          <div className="mt-3 p-2 bg-red-500 h-fit rounded-full cursor-pointer">
            <Trash2 size={18}/>
          </div>
          <div className="  space-y-3">
            ...
            <p className="text-gray-200 md:text-base text-sm">{feedback?.review}</p>
          </div>
        </div>
      ))}
